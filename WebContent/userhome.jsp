...
<html>
    <head>
        <meta charset=utf-8>
        <title>Game Shop'a Hoş Geldin</title>
    ...
    <body>
        <div class="container-fluid">
 				...
 				<!-- Modal content -->
  				<div class="modal-content">
    				...
    				<section class="container content-section">
            			...
            			<p>Lütfen ödeme yöntemi seçiniz:</p>
  							<input type="radio" id="kk" name="cart" value="kk">
  								<label for="male">Kredi Kartı&emsp;</label>
  							<input type="radio" id="bk" name="cart" value="bk">
  								<label for="female">Banka Kartı&emsp;</label>
  							<input type="radio" id="ha" name="cart" value="ha">
  								<label for="other">Havale</label><br><br>
            			<button class="btn btn-success custom btn-purchase" type="button">SATIN AL</button>
        			</section>
  				</div>
			</div>
			...
			<script>
				...
				var lm = document.getElementById("sepetimModal");
            ...
            <div class="row">
                <div class="shop-item col-lg-2 col-md-3 col-sm-4 form-group">
                    ...
                    <div class="shop-item-details">
                        ...
                        <button class="btn btn-success center-block custom shop-item-button" type="button" onclick="alert('Ürün sepete eklendi. Satın almak için sepetinize giriniz.')">Sepete Ekle</button>
                    </div>
                </div>
