        ...
        <div class="container-fluid">
            <div class="row bg">
                ...
                <div class="col-lg-10 col-md-10 col-sm-10">
                    ...
                    <h3 class="color-text"> Giriş bilgileri yanlış. Lütfen doğru giriş bilgilerinizi giriniz.</h3>
            ...
            <div class="row">
                <div class="shop-item col-lg-2 col-md-3 col-sm-4 form-group">
                    ...
                    <div class="shop-item-details">
                        ...
                        <button class="btn btn-success center-block custom" type="button" onclick="alert('Satın almak için lütfen giriş yapınız.')">Sepete Ekle</button>
                    </div>
                </div>
